...
public interface GameCore extends AutoCloseable, GameListenable {
	...
	/**
	 * Creates a new area by a name. The new area is saved if create() is called
	 * on the creator.
	 *
	 ...
	 * @return a Optional containg the game of a player, or a empty optional on
	 * failure
	 */
	...
	/**
	 * Initializes and start the gamecore. Repeated calls to this method should
	 * be ignored.
	 *
	...
	/**
	 * Returns the starting future. This <code>isDone()</code> method will
	 * return true when the clas sis succesfully loaded.
	 *
	 * @return
	 */
	...
	/**
	 * Returns true if the <code>GameCore</code> terminationsequence has
	 * started.
	 *
	...
	/**
	 * Closes and directly terminates this <code>GameCore</code>. Repeated calls
	 * to this method should be ignored
	 */
	@Override
	public void close();

	/**
	 * Gets the information that has been used to construct this
	 * <code>GameCore</code>
	 *
	 ...
	 * complete. This method delegates to <code>getInfo().getExecutor()</code>
	 *
